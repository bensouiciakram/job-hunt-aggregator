"""
Django settings for job_hunt_aggregator project.
...
SECRET_KEY = 'django-insecure-8o6(l65n=#y9-68#r@w8#%j&jru*(1148wujne^1mip0d^v+z&'
...
ROOT_URLCONF = 'job_hunt_aggregator.urls'
...
WSGI_APPLICATION = 'job_hunt_aggregator.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        # AD-2: serialize interleaved writes at the DB, not in app logic.
        # `timeout` maps to sqlite3 busy_timeout (30s) for the single-writer rule.
        'OPTIONS': {'timeout': 30},
    }
}
